...
package com.karthikr.posedetection.vision.posedetector;
...
import com.karthikr.posedetection.vision.GraphicOverlay;
...
public class PoseGraphic extends GraphicOverlay.Graphic {
    ...
    private final Paint elbowPaint;
    ...
    PoseGraphic(
        ...
        elbowPaint = new Paint();
        elbowPaint.setStrokeWidth(STROKE_WIDTH);
        elbowPaint.setTextSize(POSE_CLASSIFICATION_TEXT_SIZE);
        elbowPaint.setColor(Color.GREEN);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        double rightElbowAngle = Math.round(
                getAngle(
        ...
        double leftElbowAngle = Math.round(
                getAngle(
        ...
        double leftHipAngle = Math.round(
                getAngle(
                        pose.getPoseLandmark(PoseLandmark.LEFT_SHOULDER),
        ...
        double rightHipAngle = Math.round(
                getAngle(
                        pose.getPoseLandmark(PoseLandmark.RIGHT_SHOULDER),
        ...
        drawTextOnCanvas(
                canvas,
                "Left Elbow: " + leftElbowAngle + "degrees",
                20.0f,
                100.0f, elbowPaint
        );
        ...
        drawTextOnCanvas(
                canvas,
                "Right Elbow: " + rightElbowAngle + "degrees",
                20.0f, 200.0f,
                elbowPaint
        );
        ...
        drawTextOnCanvas(
                canvas,
                "Right Hip: " + rightHipAngle + "degrees",
                20.0f, 400.0f,
                elbowPaint
        );
    }

    void drawTextOnCanvas(
            Canvas canvas,
            String text,
            float posX,
            float posY,
